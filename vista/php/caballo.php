...
<body style="text-align:center; background-image: url('../img/f3.jpg');">
	...
	<h1 style="color:#3B91E7;font-weight:bold;">Productos para caballos</h1>
	<center>
		<div class="container">
			<img src="../img/caballo.png" class="img-responsive imguard img-fluid ml-7">
		</div>
	</center>
	<div class="row"style="margin-left: 5%;margin-right:5%;">
		<?php
		$sql="SELECT sku,nombre_producto,precio_unitario,imagen  FROM producto where mascota='caballos'";
		...
		while ($ver= mysqli_fetch_row($result)){
			...
			<div class="col-12 col-sm-6 col-md-4 col-lg-3 pb-3">
				...
				<div style="text-align: center; margin-bottom: 15px;">
					...
					<a href="producto.php?sku=<?php echo $ver[0];?>"  class="btn btn-primary">Ver información</a>
				</button>
			</div>
		</div>
