...
<body style="text-align:center; background-image: url('../img/f3.jpg');">
	...
	<h1 style="color:#3B91E7;font-weight:bold;">Productos para gatos</h1>
	<center><div class="container">
		<img src="../img/gatito.png" class="img-responsive imguard img-fluid ml-7">
	</div></center>
	<div class="row"style="margin-left: 5%;margin-right:5%;">
		<?php
		$sql="SELECT sku,nombre_producto,precio_unitario,imagen  FROM producto where mascota='gatos'";
